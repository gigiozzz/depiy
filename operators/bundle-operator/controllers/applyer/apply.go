...
func (o *applyOptions) Apply(ctx context.Context, ns string, data []byte) error {
	...
	for _, unstruct := range unstructList {
		...
		if _, err := ApplyUnstructured(ctx, ns, o.dynamicClient, restmapper, unstruct, o.serverSide); err != nil {
			return err
		}
...
func ApplyUnstructured(ctx context.Context, ns string, dynamicClient dynamic.Interface, restMapper meta.RESTMapper, unstructuredObj unstructured.Unstructured, serverSide bool) (*unstructured.Unstructured, error) {
